...
// The previous declaration had a different C++ signature, which caused the
// Arduino linker error: undefined reference to answer(String const&).
extern String answer(String q);
extern String purpose;
extern bool sdOK;
extern bool editPurpose;
extern bool vortexModelReady();
